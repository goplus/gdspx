...
#On ready
const POINTS_LABEL_SCENE = preload("res://assets/scenes/points_label.tscn")
const SMALL_MARIO_COLLISION_SHAPE = preload("res://assets/resources/collision_shapes/small_mario_collision_shape.tres")
const BIG_MARIO_COLLISION_SHAPE = preload("res://assets/resources/collision_shapes/big_mario_collision_shape.tres")
const FIREBALL_SCENE = preload("res://assets/scenes/fireball.tscn")
# References
...
func switch_to_underground():
	...
	get_tree().change_scene_to_file("res://assets/scenes/underground.tscn")
