...
const KOOPA_FULL_COLLISION_SHAPE = preload("res://assets/resources/collision_shapes/koopa_full_collision_shape.tres")
const KOOPA_SHELL_COLLISION_SHAPE = preload("res://assets/resources/collision_shapes/koopa_shell_collision_shape.tres")
