...
#Bonus References
const COIN_SCENE = preload("res://assets/scenes/coin.tscn")
const SHROOM_SCENE = preload("res://assets/scenes/shroom.tscn")
const SHOOTING_FLOWER_SCENE = preload("res://assets/scenes/shooting_flower.tscn")
